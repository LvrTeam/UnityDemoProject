...
/// <summary>
/// LVRCrosshair is a component that adds a stereoscoppic cross-hair into a scene.
/// </summary>
public class LVRCrosshair
{
    #region Variables
    public Texture ImageCrosshair 	  = null;
    public LVRCameraRig CameraController = null;
    public LVRPlayerController PlayerController = null;
    ...
    /// <summary>
    /// Sets the LVR player controller.
    /// </summary>
    /// <param name="playerController">Player controller.</param>
    public void SetLVRPlayerController(ref LVRPlayerController playerController)
    {
