...
/// <summary>
/// LVRGamepadController is an interface class to a gamepad controller.
/// </summary>
public class LVRGamepadController : MonoBehaviour
{
    ...
    {
        if (!LVRManager.instance.isSupportedPlatform)
            return false;
    ...
    public const string LibLVR = "LeVRPlugin";
