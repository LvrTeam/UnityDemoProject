...
public class LVRUGUI
{
    ...
    [HideInInspector]
    public static LVRPlayerController PlayerController = null;
    [HideInInspector]
    public static LVRCameraRig CameraController = null;
    //[HideInInspector]
    ...
    static void InitUIComponents()
    {
        ...
        NewGUIManager.transform.parent = GameObject.Find("LVRGUIMain").transform;
