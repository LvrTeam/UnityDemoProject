...
namespace LVR
{
    ...
    public enum InitFlags
    {
        ...
        /// <summary>
        // When a version is requested, LibLVR runtime will respect the RequestedMinorVersion
        // field and will verify that the RequestedMinorVersion is supported.
        /// </summary>
        RequestVersion = 0x00000004,

        /// <summary>
        // Forces debug features of LibLVR off explicitly, even if it is built in debug mode.
        /// </summary>
    ...
    /// these back ends may also use LibLVR. To do this, back ends can be modified
    ...
    {
        public const string LVR_VERSION_STRING                    = "0.5.0";
        public const string LVR_KEY_USER                          = "User";
        public const string LVR_KEY_NAME                          = "Name";
        public const string LVR_KEY_GENDER                        = "Gender";
        public const string LVR_KEY_PLAYER_HEIGHT                 = "PlayerHeight";
        public const string LVR_KEY_EYE_HEIGHT                    = "EyeHeight";
        public const string LVR_KEY_IPD                           = "IPD";
        public const string LVR_KEY_NECK_TO_EYE_DISTANCE          = "NeckEyeDistance";
        public const string LVR_KEY_EYE_RELIEF_DIAL               = "EyeReliefDial";
        public const string LVR_KEY_EYE_TO_NOSE_DISTANCE          = "EyeToNoseDist";
        public const string LVR_KEY_MAX_EYE_TO_PLATE_DISTANCE     = "MaxEyeToPlateDist";
        public const string LVR_KEY_EYE_CUP                       = "EyeCup";
        public const string LVR_KEY_CUSTOM_EYE_RENDER             = "CustomEyeRender";
        public const string LVR_KEY_CAMERA_POSITION               = "CenteredFromWorld";

        // Default measurements empirically determined at LeVR to make us happy
        ...
        public const string LVR_DEFAULT_GENDER                = "Unknown";
        public const float LVR_DEFAULT_PLAYER_HEIGHT          = 1.778f;
        public const float LVR_DEFAULT_EYE_HEIGHT             = 1.675f;
        public const float LVR_DEFAULT_IPD                    = 0.064f;
        public const float LVR_DEFAULT_NECK_TO_EYE_HORIZONTAL = 0.0805f;
        public const float LVR_DEFAULT_NECK_TO_EYE_VERTICAL   = 0.075f;
        public const float LVR_DEFAULT_EYE_RELIEF_DIAL        = 3;
        public readonly float[] LVR_DEFAULT_CAMERA_POSITION   = {0,0,0,1,0,0,0};
        ...
        /// else in LibLVR. This may be helpful if the application prefers to avoid
        /// creating any OVR resources (allocations, service connections, etc) at this point.
        /// ovr_InitializeRenderingShim does not bring up anything within LibLVR except the
        ...
        /// ovr_Initialize() must still be called after to use the rest of LibLVR APIs.
        ///
        /// Same as ovr_InitializeRenderingShim except it requests to support at least the
        /// given minor LibLVR library version.
        /// </summary>
        ...
        /// <summary>
        /// Initializes all LeVR functionality.
        ...
        /// <summary>
        /// Shuts down all LeVR functionality.
        /// </summary>
        ...
        // LeVR hardware, and enables a range of low-level optimizations.
        ...
        public const string LibFile = "LeVRPlugin";
