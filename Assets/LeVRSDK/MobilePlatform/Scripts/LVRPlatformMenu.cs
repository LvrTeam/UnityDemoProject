...
public class LVRPlatformMenu : MonoBehaviour
{
    ...
    public LVRCameraRig cameraRig = null;
    ...
    void ShowGlobalMenu()
    {
        ...
        LVRManager.PlatformUIGlobalMenu();
        platformUIStarted = true;
#endif
    }
    ...
    void UpdateCursor(float timerRotateRatio)
    {
        if (instantiatedCursorTimer != null)
        {
            ...
            LVRPose pose = LVRManager.display.GetHeadPose();
