...
/// <summary>
/// Add LVROverlay script to an object with a Quad mesh filter to have the quad
...
/// </summary>
public class LVROverlay : MonoBehaviour
{
...
#pragma warning restore 414       // The private field 'x' is assigned but its value is never used
    ...
    void Awake()
    {
        ...
        // causes a problem on the first frame if this gets called after the LVRDisplay initialization,
