...
public static class LVRMathUtils
{
    ...
    public static void Normalize(ref Quaternion q)
    {
        ...
        LVRDebugUtils.Assert( mag > FltSmallestNonDenormal );
...
/*
        ...
        if ( dot > 0.9999f )
        {
            LVRDebugUtils.Assert( dot <= 0.9999f );
        ...
        LVRDebugUtils.Assert( axis.magnitude > 0.0001f );
...
*/
        ...
        LVRDebugUtils.Assert(q.w > 1e-18f);
        Normalize(ref q);
        return q;
    }
    ...
    {
        LVRDebugUtils.Assert(QuaternionIsNormalized(a, 0.001f));
        LVRDebugUtils.Assert(QuaternionIsNormalized(b, 0.001f));
    ...
    public static bool Clamp(ref Quaternion q, float cosineOfClampAngle)
    {
        ...
        LVRDebugUtils.Assert(s > LVRMathUtils.FltSmallestNonDenormal);
