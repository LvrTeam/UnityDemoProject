...
public class LVRModeParms : MonoBehaviour
{
    ...
    private static extern void OVR_TW_SetMinimumVsyncs(LVRTimeWarpUtils.VsyncMode mode);
#endif

    #region Member Variables

    public LVRGamepadController.Button	resetButton = LVRGamepadController.Button.X;
    ...
    {
#if (UNITY_ANDROID && !UNITY_EDITOR)
        LVRManager.OnConfigureVrModeParms += ConfigureVrModeParms;
    ...
    void Update()
    {
        ...
        if ( Input.GetButtonDown(LVRGamepadController.ButtonNames[(int)resetButton]))
        {
            ...
            LVRPluginEvent.Issue(RenderEventType.ResetVrModeParms);
#endif
        }
    }
    ...
    void ConfigureVrModeParms()
    {
        ...
        OVR_TW_SetMinimumVsyncs(LVRTimeWarpUtils.VsyncMode.VSYNC_60FPS);
        // Power-save levels
        //OVR_VrModeParms_SetCpuLevel(0);
        //OVR_VrModeParms_SetGpuLevel(0);
        //OVR_TW_SetMinimumVsyncs(LVRTimeWarpUtils.VsyncMode.VSYNC_30FPS);
